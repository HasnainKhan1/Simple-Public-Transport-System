    ...
    const Accident *sample)
{
    ...
    result = AccidentPlugin_serialize(
    ...
    void *endpoint_plugin_qos)
{
    ...
    RTIBool result;
    const char *METHOD_NAME = "AccidentPlugin_deserialize";
    if (drop_sample) {} /* To avoid warnings */

    stream->_xTypesState.unassignable = RTI_FALSE;
    result= AccidentPlugin_deserialize_sample( 
    ...
    unsigned int current_alignment)
{
    ...
    size = AccidentPlugin_get_serialized_sample_max_size_ex(
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (drop_sample) {} /* To avoid warnings */
    stream->_xTypesState.unassignable = RTI_FALSE;
    result= AccidentPlugin_deserialize_key_sample(
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment += AccidentPlugin_get_serialized_sample_max_size_ex(
    ...
    unsigned int current_alignment)
{
    ...
    size = AccidentPlugin_get_serialized_key_max_size_ex(
        endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
